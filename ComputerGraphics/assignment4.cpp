...
unsigned int texture[30], rugTexture, horseTexture, carDoorTexture;
...
void desk() {
    ...
    dif_coff = 0.9;
    glPushMatrix();
    setColorRGB(color, 233, 239, 242);
    glColor3f(color[0], color[1], color[2]);
    glTranslatef(x_for_desk[2], y_for_desk[2], z_for_desk[2]);
    glScalef(column_for_desk[2], height_for_desk[2], width_for_desk[2]);
    drawCube1_front_texture(color[0] * dif_coff, color[1] * dif_coff, color[2] * dif_coff, color[0] * amb_coff, color[1] * amb_coff, color[2] * amb_coff, 50, 16);
    glPopMatrix();
}
...
void photoFrame() {
    ...
    glutSolidCube(0.1);*/
    drawCube1_front_texture(color[0] * dif_coff, color[1] * dif_coff, color[2] * dif_coff, color[0] * amb_coff, color[1] * amb_coff, color[2] * amb_coff, 1, 10);
    glPopMatrix();
...
void drawCube1_front_other_texture(GLfloat difX, GLfloat difY, GLfloat difZ, GLfloat ambX = 0, GLfloat ambY = 0, GLfloat ambZ = 0, GLfloat shine = 0, int frontTextuereIndex = -1, int otherTextureIndex = -1) {
    GLfloat no_mat[] = { 0.0, 0.0, 0.0, 1.0 };
    GLfloat mat_ambient[] = { ambX, ambY, ambZ, 1.0 };
    GLfloat mat_diffuse[] = { difX, difY, difZ, 1.0 };
    GLfloat mat_specular[] = { 1.0, 1.0, 1.0, 1.0 };
    ...
    glBindTexture(GL_TEXTURE_2D, texture[otherTextureIndex]);
    glBegin(GL_QUADS);
    for (GLint i = 0; i < 6; i++)
    {
        if (i == 2)
    ...
    glBindTexture(GL_TEXTURE_2D, texture[frontTextuereIndex]);
    glBegin(GL_QUADS);
    getNormal3p(v_cube[quadIndices[i][0]][0], v_cube[quadIndices[i][0]][1], v_cube[quadIndices[i][0]][2],
        v_cube[quadIndices[i][1]][0], v_cube[quadIndices[i][1]][1], v_cube[quadIndices[i][1]][2],
        v_cube[quadIndices[i][2]][0], v_cube[quadIndices[i][2]][1], v_cube[quadIndices[i][2]][2]);
...
void car(void)
{
    ...
    glScalef(1.8, 0.5, 0.8);
    drawCube1(color[0] * dif_coff, color[1] * dif_coff, color[2] * dif_coff, color[0] * amb_coff, color[1] * amb_coff, color[2] * amb_coff, 5, 20);
    ...
    setColorRGB(color, 255, 255, 255);
    glColor3f(color[0], color[1], color[2]);
    drawCube1_front_other_texture(color[0] * dif_coff, color[1] * dif_coff, color[2] * dif_coff, color[0] * amb_coff, color[1] * amb_coff, color[2] * amb_coff, 1, 21, 19);

    glPopMatrix();

    /*glPushMatrix();
    glTranslatef(1, 0.87, -.001);
    glScalef(0.5, 1.2, 1);
    glRotatef(230, 0, 0, 250);
    drawCube1(color[0] * dif_coff, color[1] * dif_coff, color[2] * dif_coff, color[0] * amb_coff, color[1] * amb_coff, color[2] * amb_coff, 6);
    glPopMatrix();*/
...
void shelf() {
    ...
    setColorRGB(color, 217, 216, 212);
    glColor3f(color[0], color[1], color[2]);
    glScalef(0.16, 0.07, 0.05);
    /*setMaterial(color[0] * dif_coff, color[1] * dif_coff, color[2] * dif_coff, color[0] * amb_coff, color[1] * amb_coff, color[2] * amb_coff);
    glutSolidCube(0.1);*/
    drawCube1(color[0] * dif_coff, color[1] * dif_coff, color[2] * dif_coff, color[0] * amb_coff, color[1] * amb_coff, color[2] * amb_coff, 50, 12);
    glPopMatrix();
}
...
void init(void)
{
    ...
    glGenTextures(30, texture); //texture size 만큼
    ...
    img = stbi_load("images/windowWall.jpg", &width, &height, &nrChannels, 0);
    ...
    //roomWall
    img = stbi_load("images/roomWall.jpeg", &width, &height, &nrChannels, 0);
    ...
    img = stbi_load("images/wrinkle.jpg", &width, &height, &nrChannels, 0);
    ...
    //horse
    img = stbi_load("images/horse.jpg", &width, &height, &nrChannels, 0);
    ...
    //brick
    img = stbi_load("images/brick.jpg", &width, &height, &nrChannels, 0);
    ...
    //beige wood
    img = stbi_load("images/beige_wood.jpg", &width, &height, &nrChannels, 0);
    ...
    //metal
    img = stbi_load("images/metal.jpg", &width, &height, &nrChannels, 0);
    ...
    //cabinet
    img = stbi_load("images/cabinet.jpg", &width, &height, &nrChannels, 0);
    ...
    //cabinet
    img = stbi_load("images/cabinet2.jpg", &width, &height, &nrChannels, 0);
    ...
    //car
    img = stbi_load("images/car.jpg", &width, &height, &nrChannels, 0);
    ...
    //car logo
    img = stbi_load("images/lambo.png", &width, &height, &nrChannels, 0);
    ...
    img = stbi_load("images/carWindow.jpeg", &width, &height, &nrChannels, 0);
    ...
    img = stbi_load("images/carDoor.jpg", &width, &height, &nrChannels, 0);
    ...
    img = stbi_load("images/carHead.jpg", &width, &height, &nrChannels, 0);
    ...
    img = stbi_load("images/carHeadWindow.jpg", &width, &height, &nrChannels, 0);
